...
## Bonus - Quantifying Efficiency Gain in our Example
If I were to send the entire original image used in the example above, I will need to send them $$267,300 (=405 \times 660)$$ numbers. Instead, if were to share the first 15 Singular Vectors ($$9,900 (=15 \times 660)$$$ numbers), and the projection lengths of A on each of the 15 Singular Vectors ($$6,075 (=405 \times 15)$$, I would only need to send a total of $$15,975$$ numbers. That's a significant saving!
