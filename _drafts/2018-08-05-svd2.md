...
Let me get started by restating the magic result provided in Section 3.4.1 of _The Elements of Statistical Learning_:
...
_Note: This result is proved in the book in three lines, however I am going to elaborate on the proof below, so that every step from the book is clear to the reader._
