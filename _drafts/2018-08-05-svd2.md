...
&= \sum_{j=1}^{p} \underbrace{\underbrace{(u_j^{T}y)}_{\text{Length of projection of y on $u_j$}} \space \underbrace{u_j}_{\text{Unit vector}}}_{\text{Projection of $y$ on $u_j$}} \tag{bb}
\end{align}
$$ 
