...
_Note: This is a good time to introduce some important terminology. We can calculate projection lengths of ALL rows of matrix $$A$$ on vector $$V_1$$ through the matrix product $$AV_1$$, also known as the **First Principal Component** of $$A$$._
